...
class AuthServices {
  ...
  /*static Future<bool> Register({
    ...
    try {
      ...
      App_Snackbar(
        type: false,
        msg: AppFirebaseAuthException(errorMessage: error.code).message,
      );
      return false;
    } catch (error) {
      App_Snackbar(type: false, msg: "Something Went Wrong");
      return false;
    }
  }*/
  ...
  static Future AddUserToDatabase({required App_User appUser}) async {
    try {
      await CollectionService.UserCollection.doc().set(appUser.toJson());
    } catch (error) {
      App_Snackbar(type: false, msg: AppStrings.somethingWentWrong);
    }
  }
